...
const ProjectList: React.FC = () => {
  ...
  return (
    <div>
      <div className="bg-[#3A79CE] mb-[50px] z-10 pt-32 px-20 flex flex-col w-screen h-[50vh] top-0 text-white relative">
        <div className="flex flex-col justify-center h-full">
          ...
          <div className="mt-4">
            <p className="font-normal text-xl max-w-4xl">
        ...
        <div className="absolute right-5 top-[15rem] transform -translate-y-1/2">
